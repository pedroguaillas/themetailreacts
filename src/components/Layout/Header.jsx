...
const Header = () =>{
    return(
        <>
         <header>
          <nav className="flex py-2 place-content-end ">
            <div className="hidden sm:hidenn flex-grow gap-x-3 items-center md:hidden lg:flex">
              <img
                className="w-[2rem] h-[2rem]  "
                src={logo}
                alt="Logo de pagina principal"
              />
              <h2 className=" text-2xl text-zinc-500 font-bold">
                PETER<span className=" text-red-500">IO</span>
              </h2>
            </div>
            <div className="flex flex-row gap-x-4 flex-wrap items-center pr-4 sm:pr-0">
              <div className=" relative flex gap-x-3 bg-slate-300 rounded-md p-1">
                <span className=" hover:bg-cyan-600 hover:rounded">
                  <svg
                    version="1.0"
                    id="Layer_1"
              ...
              <div className="text-sm text-slate-500">
                <h3>
                  Hola,<span className="font-bold text-black"> Peter</span>
                </h3>
                <p>Administrador</p>
              </div>
              <img
